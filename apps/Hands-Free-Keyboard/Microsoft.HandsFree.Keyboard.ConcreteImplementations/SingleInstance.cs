...

    {
        ...
        public static bool InitializeAsFirstInstance(string uniqueName)
        {
            ...
            else
            {
                ...
                {
                    // True first instance has not shutdown properly. We cannot bring it
                    // back to life, so start anyway. This breaks the single instance behavior
                    // but is a better response than preventing the application starting.
                    firstInstance = true;
                }
            }
